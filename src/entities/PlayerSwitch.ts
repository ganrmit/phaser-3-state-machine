// First attempt at modelling the player state machine with switch statements.
// It's painful and incomplete. I am retiring this version and leaving it as an example.
// Check out the Class based version for a comparison.
